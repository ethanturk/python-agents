...
export const config = {
  ...
  OPENAI_API_BASE:
    process.env.OPENAI_API_BASE || "http://192.168.5.203:1234/v1",
  ...
  RUN_WORKER_EMBEDDED:
    (process.env.RUN_WORKER_EMBEDDED || "false").toLowerCase() === "true",

  // Firebase Configuration
  FIREBASE_REQUIRED:
    (process.env.FIREBASE_REQUIRED || "false").toLowerCase() === "true",
