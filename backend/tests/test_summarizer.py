...
def test_summarize_document_xls_conversion(mock_document_converter, mock_openai_agent_summarizer, mocker):
...
def test_summarize_document_large_split(mock_document_converter, mock_openai_agent_summarizer, mocker):
    # Mock large content causing split
    long_content = "a" * 200000 
    mock_document_converter.convert.return_value.document.export_to_markdown.return_value = long_content
