...
with patch.dict(
    os.environ,
    {
        ...
        "OPENAI_API_BASE": "https://api.mock.com/v1",
        "OPENAI_MODEL": "mock-model",
        "VECTOR_TABLE_NAME": "test",
        "CELERY_QUEUE_NAME": "test",
    },
):
    # Mock VectorDBService inside imports if needed, or patch where used
    # with patch('services.vector_db.db_service...'):
    #     pass
    from sync_agent import perform_rag, run_sync_agent

    from async_tasks import answer_question, check_knowledge_base


class TestPydanticMigration(unittest.TestCase):
    @patch("sync_agent.Agent")
    def test_run_sync_agent(self, MockAgent):  # noqa: N803
        # Setup mock agent
    ...
    def test_perform_rag(self, mock_search, MockAgent):  # noqa: N803
    ...
    def test_async_check_kb(self, mock_exists, MockAgent):  # noqa: N803
    ...
    @patch("async_tasks.Agent")
    def test_async_answer_question(self, MockAgent):  # noqa: N803
        ...
        context_data = {"kb_location": "stub_knowledge_base.txt", "user_input": "Full Input"}
